...
def merge_dates_and_towns_into_csv(dates_filename: str, towns_filename: str, csv_output_filename: str) -> None:
    ...
    :return: None
    """
    dates_lines = read_file_contents_to_list(dates_filename)
    towns_lines = read_file_contents_to_list(towns_filename)
